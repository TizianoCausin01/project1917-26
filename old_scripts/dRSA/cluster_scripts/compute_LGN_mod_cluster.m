...
%numCores = 3; % to run in parallel the 6 rois
%parpool('local',numCores)
addpath(genpath("/mnt/storage/tier2/ingdev/projects/TIZIANO/Project1917/code/LGNstatistics"))
%%
stim_dir = "/mnt/storage/tier2/ingdev/projects/TIZIANO/stimuli/";
out_dir = "/mnt/storage/tier2/ingdev/projects/TIZIANO/models/";
path2OF = "/mnt/storage/tier2/ingdev/projects/TIZIANO/models/Project1917_OFdir_run%02d_movie24Hz.mat";
img_len = [522, 1280];
...
ipart=1
    ...
    fn2load = sprintf('%sProject1917_movie_part%d_24Hz.avi',stim_dir,ipart);
