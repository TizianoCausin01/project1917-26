...
from analyses.subsampling_lagged_comparisons import multivariate_lagged_comparisons_temp
...
master_workers_queue(task_list, paths, multivariate_lagged_comparisons_temp, *(cfg.analysis_type, cfg.sensors_group, cfg.iterations_n, cfg.pseudotrial_len, cfg.neu_fs, mod_fs, model_len, cfg.signal_metric, cfg.model_metric, cfg.pseudotrials_n, cfg.sq_side, cfg.regress_out_gaze, cfg.gaze_fs, cfg.timepts_to_regress_out, cfg.PCs_to_regress_out, cfg.n_model_components), **{"pooling": cfg.pooling}) 
