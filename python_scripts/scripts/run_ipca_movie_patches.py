...
if __name__ == "__main__":
    ...
    master_workers_queue(task_list, paths, ipca_movie_patches, *(cfg.model_name, model, cfg.n_components, cfg.batch_size, cfg.patches_per_frame, cfg.frames_step, cfg.patches_overhead_sampling, cfg.sq_size, cfg.input_size, cfg.pooling,)) 
